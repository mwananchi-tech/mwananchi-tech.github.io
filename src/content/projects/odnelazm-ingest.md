...
The engine behind Bunge Hub. Handles scraping, extraction, member linking, and AI enrichment. Runs locally with no cloud dependency today, with a path to a hosted setup in future.
